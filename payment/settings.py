...
SECRET_KEY = 'django-insecure-1$9yrh&x($hz0gz9oys#%%n@lpj*k$(h%6*8ksaou8+q8k4ioj'
...
CSRF_TRUSTED_ORIGINS = [
    'https://tak-payments-api.up.railway.app',
...
# FLUTTERWAVE_SECRET_HASH = "your_secret_hash"  # Generate a strong, random string and set it here
